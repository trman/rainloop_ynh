...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! bootstrap */ 70)(__webpack_require__(/*! App/User */ 6));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			IdentityStore = __webpack_require__(/*! Stores/User/Identity */ 66),
			TemplateStore = __webpack_require__(/*! Stores/User/Template */ 85),
			FolderStore = __webpack_require__(/*! Stores/User/Folder */ 21),
			PgpStore = __webpack_require__(/*! Stores/User/Pgp */ 23),
			MessageStore = __webpack_require__(/*! Stores/User/Message */ 26),
			...
			EmailModel = __webpack_require__(/*! Model/Email */ 25),
			FolderModel = __webpack_require__(/*! Model/Folder */ 102),
			AccountModel = __webpack_require__(/*! Model/Account */ 97),
			IdentityModel = __webpack_require__(/*! Model/Identity */ 103),
			TemplateModel = __webpack_require__(/*! Model/Template */ 106),
			OpenPgpKeyModel = __webpack_require__(/*! Model/OpenPgpKey */ 105),
	...
	//		});
		...
		AppUser.prototype.bootstartLoginScreen = function ()
		{
			...
			if (!sCustomLoginLink)
			{
				...
				kn.startScreens([
					__webpack_require__(/*! Screen/User/Login */ 110)
				]);
	...
	//require.ensure([], function() { // require code splitting
				...
				self.folders(_.bind(function (bValue) {
					...
					if (bValue)
					{
						...
						kn.startScreens([
							__webpack_require__(/*! Screen/User/MailBox */ 111),
							__webpack_require__(/*! Screen/User/Settings */ 112),
							__webpack_require__(/*! Screen/User/About */ 109)
						]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			Utils = __webpack_require__(/*! Common/Utils */ 1),
			Consts = __webpack_require__(/*! Common/Consts */ 15),
			Base64 = __webpack_require__(/*! Common/Base64 */ 94),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			MessageModel = __webpack_require__(/*! Model/Message */ 104)
		;
			...
			if (Cache.getFolderInboxName() === sFolder && Utils.isNormal(sUidNext) && sUidNext !== '')
			{
				if (Utils.isArray(aNewMessages) && 0 < aNewMessages.length)
				{
					var
						...
						NotificationStore = __webpack_require__(/*! Stores/User/Notification */ 67)
					;
				...
				if (oMessagesBodiesDom)
				{
					...
					if (!oTextBody || !oTextBody[0])
					{
						...
						else if (Utils.isNormal(oData.Result.Plain) && '' !== oData.Result.Plain)
						{
							...
							if ((oMessage.isPgpSigned() || oMessage.isPgpEncrypted()) && __webpack_require__(/*! Stores/User/Pgp */ 23).capaOpenPGP())
							{
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			ko = __webpack_require__(/*! ko */ 3),
			moment = __webpack_require__(/*! moment */ 33),
			JSON = __webpack_require__(/*! JSON */ 74),
			Jua = __webpack_require__(/*! Jua */ 75),
			...
			ComposeAttachmentModel = __webpack_require__(/*! Model/ComposeAttachment */ 98),
		...
		function ComposePopupView()
		{
			...
			this.contactsCommand = Utils.createCommand(this, function () {
				...
				if (this.allowContacts)
				{
					...
					_.delay(function () {
						kn.showScreenPopup(__webpack_require__(/*! View/Popup/Contacts */ 69),
		...
		ComposePopupView.prototype.openOpenPgpPopup = function ()
		{
			...
			{
				var self = this;
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/ComposeOpenPgp */ 140), [
					function (sResult) {
		...
		function ClientStorage()
		{
			var
				NextStorageDriver = __webpack_require__(/*! _ */ 2).find([
					__webpack_require__(/*! Common/ClientStorageDriver/LocalStorage */ 96),
					__webpack_require__(/*! Common/ClientStorageDriver/Cookie */ 95)
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			window = __webpack_require__(/*! window */ 11),
			ko = __webpack_require__(/*! ko */ 3),
			buzz = __webpack_require__(/*! buzz */ 158),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			Globals = __webpack_require__(/*! Common/Globals */ 7),
			Utils = __webpack_require__(/*! Common/Utils */ 1),
			Selector = __webpack_require__(/*! Common/Selector */ 79),
			Links = __webpack_require__(/*! Common/Links */ 13),
			Translator = __webpack_require__(/*! Common/Translator */ 8),
			...
			EmailModel = __webpack_require__(/*! Model/Email */ 25),
			ContactModel = __webpack_require__(/*! Model/Contact */ 99),
			ContactPropertyModel = __webpack_require__(/*! Model/ContactProperty */ 100),
		...
		function ContactsPopupView()
		{
			...
			this.newMessageCommand = Utils.createCommand(this, function () {
				...
				if (Utils.isNonEmptyArray(aE))
				{
					...
					kn.hideScreenPopup(__webpack_require__(/*! View/Popup/Contacts */ 69));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			FilterConditionModel = __webpack_require__(/*! Model/FilterCondition */ 101),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/KeyboardShortcutsHelp */ 91));
		};
		...
		AbstractSystemDropDownUserView.prototype.addAccountClick = function ()
		{
			...
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Account */ 68));
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AttachmentModel = __webpack_require__(/*! Model/Attachment */ 80),
	...
	(function () {
		...
		MessageModel.prototype.initUpdateByMessageJson = function (oJsonMessage)
		{
			...
			if (oJsonMessage && 'Object/Message' === oJsonMessage['@Object'])
			{
				...
				if (__webpack_require__(/*! Stores/User/Pgp */ 23).capaOpenPGP())
				{
		...
		{
			if (this.body && __webpack_require__(/*! Stores/User/Pgp */ 23).capaOpenPGP())
			{
				this.body.data('rl-pgp-verify-status', this.pgpSignedVerifyStatus());
				this.body.data('rl-pgp-verify-user', this.pgpSignedVerifyUser());
			}
	...
	(function () {
		...
		function AboutUserScreen()
		{
			AbstractScreen.call(this, 'about', [
				__webpack_require__(/*! View/User/About */ 146)
			]);
		}
	...
	(function () {
		...
		function LoginUserScreen()
		{
			AbstractScreen.call(this, 'login', [
				__webpack_require__(/*! View/User/Login */ 147)
			]);
		}
	...
	(function () {
		...
		function MailBoxUserScreen()
		{
			AbstractScreen.call(this, 'mailbox', [
				__webpack_require__(/*! View/User/MailBox/SystemDropDown */ 151),
				__webpack_require__(/*! View/User/MailBox/FolderList */ 148),
				__webpack_require__(/*! View/User/MailBox/MessageList */ 149),
				__webpack_require__(/*! View/User/MailBox/MessageView */ 150)
			]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractSettingsScreen = __webpack_require__(/*! Screen/AbstractSettings */ 60)
		;
		...
		function SettingsUserScreen()
		{
			AbstractSettingsScreen.call(this, [
				__webpack_require__(/*! View/User/Settings/SystemDropDown */ 154),
				__webpack_require__(/*! View/User/Settings/Menu */ 152),
				__webpack_require__(/*! View/User/Settings/Pane */ 153)
			]);
		...
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/General */ 129),
				'SettingsGeneral', 'SETTINGS_LABELS/LABEL_GENERAL_NAME', 'general', true);

			if (AppStore.contactsIsAllowed())
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Contacts */ 126),
					'SettingsContacts', 'SETTINGS_LABELS/LABEL_CONTACTS_NAME', 'contacts');
			}

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Accounts */ 124), 'SettingsAccounts',
			...
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Filters */ 127),
			...
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Security */ 131),
			...
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Social */ 132),
					'SettingsSocial', 'SETTINGS_LABELS/LABEL_SOCIAL_NAME', 'social');
			}

			if (Settings.settingsGet('ChangePasswordIsAllowed'))
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/ChangePassword */ 125),
					'SettingsChangePassword', 'SETTINGS_LABELS/LABEL_CHANGE_PASSWORD_NAME', 'change-password');
			}

			if (Settings.capa(Enums.Capa.Templates))
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Templates */ 133),
					'SettingsTemplates', 'SETTINGS_LABELS/LABEL_TEMPLATES_NAME', 'templates');
			}

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Folders */ 128),
				'SettingsFolders', 'SETTINGS_LABELS/LABEL_FOLDERS_NAME', 'folders');

			if (Settings.capa(Enums.Capa.Themes))
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Themes */ 134),
					'SettingsThemes', 'SETTINGS_LABELS/LABEL_THEMES_NAME', 'themes');
			}

			if (Settings.capa(Enums.Capa.OpenPGP))
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/OpenPgp */ 130),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		AccountsUserSettings.prototype.editAccount = function (oAccountItem)
		{
			...
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Account */ 68), [oAccountItem]);
			}
		};

		AccountsUserSettings.prototype.addNewIdentity = function ()
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Identity */ 90));
		};

		AccountsUserSettings.prototype.editIdentity = function (oIdentity)
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Identity */ 90), [oIdentity]);
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		FiltersUserSettings.prototype.updateList = function ()
		{
			var
				self = this,
				FilterModel = __webpack_require__(/*! Model/Filter */ 81)
			;
		...
		FiltersUserSettings.prototype.addFilter = function ()
		{
			...
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(
				__webpack_require__(/*! View/Popup/Filter */ 88), [oNew, function  () {
		...
		FiltersUserSettings.prototype.editFilter = function (oEdit)
		{
			...
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(
				__webpack_require__(/*! View/Popup/Filter */ 88), [oCloned, function  () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/FolderCreate */ 89));
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/AddOpenPgpKey */ 138));
		};

		OpenPgpUserSettings.prototype.generateOpenPgpKey = function ()
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/NewOpenPgpKey */ 142));
		};
		...
		OpenPgpUserSettings.prototype.viewOpenPgpKey = function (oOpenPgpKey)
		{
			if (oOpenPgpKey)
			{
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/ViewOpenPgpKey */ 145), [oOpenPgpKey]);
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/TwoFactorTest */ 144), [this.twoFactorTested]);
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Template */ 92));
		};
		...
		TemplatesUserSettings.prototype.editTemplate = function (oTemplateItem)
		{
			if (oTemplateItem)
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Template */ 92), [oTemplateItem]);
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderCreate */ 89));
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			key = __webpack_require__(/*! key */ 19),
			Jua = __webpack_require__(/*! Jua */ 75),
			ifvisible = __webpack_require__(/*! ifvisible */ 159),
		...
		function MessageListMailBoxUserView()
		{
			...
			this.clearCommand = Utils.createCommand(this, function () {
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderClear */ 141), [FolderStore.currentFolder()]);
			});
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/AdvancedSearch */ 139));
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			PhotoSwipe = __webpack_require__(/*! PhotoSwipe */ 156),
			PhotoSwipeUI_Default = __webpack_require__(/*! PhotoSwipeUI_Default */ 157),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			kn = __webpack_require__(/*! Knoin/Knoin */ 5),
			AbstractSystemDropDownViewModel = __webpack_require__(/*! View/User/AbstractSystemDropDown */ 93)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Stores/User/Message */ 26).message(null);
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			kn = __webpack_require__(/*! Knoin/Knoin */ 5),
			AbstractSystemDropDownUserView = __webpack_require__(/*! View/User/AbstractSystemDropDown */ 93)
		;
