...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! bootstrap */ 73)(__webpack_require__(/*! App/Admin */ 17));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			DomainStore = __webpack_require__(/*! Stores/Admin/Domain */ 64),
			PluginStore = __webpack_require__(/*! Stores/Admin/Plugin */ 67),
			LicenseStore = __webpack_require__(/*! Stores/Admin/License */ 65),
			PackageStore = __webpack_require__(/*! Stores/Admin/Package */ 66),
			CoreStore = __webpack_require__(/*! Stores/Admin/Core */ 86),
		...
		AdminApp.prototype.bootstart = function ()
		{
			...
			__webpack_require__(/*! Stores/Admin/Capa */ 44).populate();
			...
			else
			{
				...
				{
					kn.startScreens([
						__webpack_require__(/*! Screen/Admin/Settings */ 116)
					]);
				}
				else
				{
					kn.startScreens([
						__webpack_require__(/*! Screen/Admin/Login */ 115)
					]);
				}
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			CapaAdminStore = __webpack_require__(/*! Stores/Admin/Capa */ 44),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! App/Admin */ 17).setWindowTitle('');
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractSettings = __webpack_require__(/*! Screen/AbstractSettings */ 63)
		;
		...
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/General */ 125),
				'AdminSettingsGeneral', 'General', 'general', true);

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Login */ 127),
				'AdminSettingsLogin', 'Login', 'login');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Branding */ 122),
				'AdminSettingsBranding', 'Branding', 'branding');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Contacts */ 123),
				'AdminSettingsContacts', 'Contacts', 'contacts');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Domains */ 124),
			...
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Plugins */ 129),
				'AdminSettingsPlugins', 'Plugins', 'plugins');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Packages */ 128),
				'AdminSettingsPackages', 'Packages', 'packages');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/Licensing */ 126),
				'AdminSettingsLicensing', 'Licensing', 'licensing');

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/Admin/About */ 121),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Domain */ 91));
		};
		...
		DomainsAdminSettings.prototype.onDomainLoadRequest = function (sResult, oData)
		{
			if (Enums.StorageResultType.Success === sResult && oData && oData.Result)
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Domain */ 91), [oData.Result]);
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Activate */ 90));
		};

		LicensingAdminSettings.prototype.showTrialForm = function ()
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Activate */ 90), [true]);
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		PluginsAdminSettings.prototype.onPluginLoadRequest = function (sResult, oData)
		{
			if (Enums.StorageResultType.Success === sResult && oData && oData.Result)
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Plugin */ 151), [oData.Result]);
			}
		};
	...
	(function () {
		...
		function PaneSettingsAdminView()
		{
			...
			this.adminManLoading = ko.computed(function () {
				return '000' !== [
					__webpack_require__(/*! Stores/Admin/Domain */ 64).domains.loading() ? '1' : '0',
					__webpack_require__(/*! Stores/Admin/Plugin */ 67).plugins.loading() ? '1' : '0',
					__webpack_require__(/*! Stores/Admin/Package */ 66).packages.loading() ? '1' : '0'
				].join('');
			}, this);
