...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! bootstrap */ 73)(__webpack_require__(/*! App/User */ 6));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			Autolinker = __webpack_require__(/*! Autolinker */ 75),
			JSEncrypt = __webpack_require__(/*! JSEncrypt */ 76),

			Mime = __webpack_require__(/*! Common/Mime */ 51),
		...
		Utils.mailToHelper = function (sMailToUrl, PopupComposeVoreModel)
		{
			if (sMailToUrl && 'mailto:' === sMailToUrl.toString().substr(0, 7).toLowerCase())
			{
				...
				var
					...
					aBcc = null,
					oParams = {},
					EmailModel = __webpack_require__(/*! Model/Email */ 26),
		...
		Utils.windowPopupKnockout = function (oViewModel, sTemplateID, sTitle, fCallback)
		{
			...
			window[sFunc] = function () {
				...
				if (oWin && oWin.document.body && oTemplate && oTemplate[0])
				{
					...
					__webpack_require__(/*! Common/Translator */ 8).i18nToNodes(oBody);
...
/***/ function(module, exports, __webpack_require__) {
	...
	//				});
		...
		ko.bindingHandlers.moment = {
			'init': function (oElement, fValueAccessor) {
				__webpack_require__(/*! Common/Momentor */ 21).momentToNode(
		...
		ko.bindingHandlers.i18nInit = {
			'init': function (oElement) {
				__webpack_require__(/*! Common/Translator */ 8).i18nToNodes(oElement);
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			$ = __webpack_require__(/*! $ */ 12),
			ko = __webpack_require__(/*! ko */ 3),
			hasher = __webpack_require__(/*! hasher */ 80),
			crossroads = __webpack_require__(/*! crossroads */ 42),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			_ = __webpack_require__(/*! _ */ 2),
			$ = __webpack_require__(/*! $ */ 12),
			SimplePace = __webpack_require__(/*! SimplePace */ 79),
			Tinycon = __webpack_require__(/*! Tinycon */ 166),
			...
			Translator = __webpack_require__(/*! Common/Translator */ 8),
			Momentor = __webpack_require__(/*! Common/Momentor */ 21),
			...
			SettingsStore = __webpack_require__(/*! Stores/User/Settings */ 25),
			AccountStore = __webpack_require__(/*! Stores/User/Account */ 32),
			IdentityStore = __webpack_require__(/*! Stores/User/Identity */ 69),
			TemplateStore = __webpack_require__(/*! Stores/User/Template */ 89),
			FolderStore = __webpack_require__(/*! Stores/User/Folder */ 20),
			PgpStore = __webpack_require__(/*! Stores/User/Pgp */ 24),
			MessageStore = __webpack_require__(/*! Stores/User/Message */ 30),
			ContactStore = __webpack_require__(/*! Stores/User/Contact */ 45),

			Local = __webpack_require__(/*! Storage/Client */ 39),
			Settings = __webpack_require__(/*! Storage/Settings */ 9),

			Remote = __webpack_require__(/*! Remote/User/Ajax */ 14),
			Promises = __webpack_require__(/*! Promises/User/Ajax */ 43),

			EmailModel = __webpack_require__(/*! Model/Email */ 26),
			AccountModel = __webpack_require__(/*! Model/Account */ 102),
			IdentityModel = __webpack_require__(/*! Model/Identity */ 108),
			TemplateModel = __webpack_require__(/*! Model/Template */ 112),
			OpenPgpKeyModel = __webpack_require__(/*! Model/OpenPgpKey */ 111),

			AbstractApp = __webpack_require__(/*! App/Abstract */ 49)
		;
		...
		AppUser.prototype.deleteMessagesFromFolder = function (iDeleteType, sFromFolderFullNameRaw, aUidForRemove, bUseFolder)
		{
			...
			{
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderSystem */ 46), [nSetSystemFoldersNotification]);
			}
			...
			{
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/Ask */ 41), [Translator.i18n('POPUPS_ASK/DESC_WANT_DELETE_MESSAGES'), function () {
	...
	//		});
		...
		AppUser.prototype.quota = function ()
		{
			Remote.quota(function (sResult, oData) {
				...
				{
					__webpack_require__(/*! Stores/User/Quota */ 88).populateData(
		...
		AppUser.prototype.bootstartLoginScreen = function ()
		{
			...
			if (!sCustomLoginLink)
			{
				...
				kn.startScreens([
					__webpack_require__(/*! Screen/User/Login */ 118)
				]);
		...
		AppUser.prototype.bootstart = function ()
		{
			...
			__webpack_require__(/*! Stores/User/App */ 29).populate();
			__webpack_require__(/*! Stores/User/Settings */ 25).populate();
			__webpack_require__(/*! Stores/User/Notification */ 70).populate();
			__webpack_require__(/*! Stores/User/Account */ 32).populate();
			__webpack_require__(/*! Stores/User/Contact */ 45).populate();

			var
				self = this,
				$LAB = __webpack_require__(/*! $LAB */ 163),
	...
	//require.ensure([], function() { // require code splitting
				...
				self.foldersReload(_.bind(function (bValue) {
					...
					if (bValue)
					{
						...
						kn.startScreens([
							__webpack_require__(/*! Screen/User/MailBox */ 119),
							__webpack_require__(/*! Screen/User/Settings */ 120),
							__webpack_require__(/*! Screen/User/About */ 117)
						]);
	...
	(function () {
		...
		Translator.prototype.reloadData = function ()
		{
			if (window['rainloopI18N'])
			{
				...
				__webpack_require__(/*! Common/Momentor */ 21).reload();
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			Utils = __webpack_require__(/*! Common/Utils */ 1),
			Consts = __webpack_require__(/*! Common/Consts */ 15),
			Base64 = __webpack_require__(/*! Common/Base64 */ 99),
			...
			AppStore = __webpack_require__(/*! Stores/User/App */ 29),
			SettingsStore = __webpack_require__(/*! Stores/User/Settings */ 25),

			AbstractAjaxRemote = __webpack_require__(/*! Remote/AbstractAjax */ 62)
		;
	...
	(function () {
		...
		FolderUserStore.prototype.getNextFolderNames = function (bBoot)
		{
			...
			var
				aResult = [],
				iLimit = 5,
				iUtc = __webpack_require__(/*! Common/Momentor */ 21).momentNowUnix(),
				iTimeout = iUtc - 60 * 5,
				aTimeouts = [],
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			$ = __webpack_require__(/*! $ */ 12),
			_ = __webpack_require__(/*! _ */ 2),
			moment = __webpack_require__(/*! moment */ 48),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			return this.findPrivateKeyByEmail(__webpack_require__(/*! Stores/User/Account */ 32).email(), sPassword);
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			$ = __webpack_require__(/*! $ */ 12),
			ko = __webpack_require__(/*! ko */ 3),
			JSON = __webpack_require__(/*! JSON */ 77),
			Jua = __webpack_require__(/*! Jua */ 78),
			...
			Events = __webpack_require__(/*! Common/Events */ 28),
			Links = __webpack_require__(/*! Common/Links */ 13),
			HtmlEditor = __webpack_require__(/*! Common/HtmlEditor */ 50),
			...
			ComposeAttachmentModel = __webpack_require__(/*! Model/ComposeAttachment */ 103),
		...
		function ComposePopupView()
		{
			...
			this.sendCommand = Utils.createCommand(this, function () {
				...
				else
				{
					...
					if ('' === sSentFolder)
					{
						kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderSystem */ 46), [Enums.SetSystemFoldersNotification.Sent]);
					}
					else
					{
			...
			this.saveCommand = Utils.createCommand(this, function () {
				...
				{
					kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderSystem */ 46), [Enums.SetSystemFoldersNotification.Draft]);
				}
				else
				{
			...
			this.contactsCommand = Utils.createCommand(this, function () {
				...
				if (this.allowContacts)
				{
					...
					_.delay(function () {
						kn.showScreenPopup(__webpack_require__(/*! View/Popup/Contacts */ 72),
		...
		ComposePopupView.prototype.openOpenPgpPopup = function ()
		{
			...
			{
				var self = this;
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/ComposeOpenPgp */ 148), [
					function (sResult) {
	...
	//}, 1000);
			...
			aToEmails, aCcEmails, aBccEmails, sCustomSubject, sCustomPlainText)
		{
			...
			if (AppStore.composeInEdit())
			{
				...
				{
					kn.showScreenPopup(__webpack_require__(/*! View/Popup/Ask */ 41), [Translator.i18n('COMPOSE/DISCARD_UNSAVED_DATA'), function () {
		...
		ComposePopupView.prototype.tryToClosePopup = function ()
		{
			var
				self = this,
				PopupsAskViewModel = __webpack_require__(/*! View/Popup/Ask */ 41)
			;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AppStore = __webpack_require__(/*! Stores/App */ 68)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			MessageModel = __webpack_require__(/*! Model/Message */ 109),
			MessageHelper = __webpack_require__(/*! Helper/Message */ 60)
		;
			...
			if (Cache.getFolderInboxName() === sFolder && Utils.isNormal(sUidNext) && sUidNext !== '')
			{
				if (Utils.isArray(aNewMessages) && 0 < aNewMessages.length)
				{
					var
						...
						NotificationStore = __webpack_require__(/*! Stores/User/Notification */ 70)
					;
					...
					if (3 < iLen)
					{
						NotificationStore.displayDesktopNotification(
							...
							__webpack_require__(/*! Stores/User/Account */ 32).email(),
		...
		MessageUserStore.prototype.setMessage = function (oData, bCached)
		{
				...
				oMessage.folderFullNameRaw === oData.Result.Folder)
			{
				...
				if (oMessage && oMessage.uid === oData.Result.Uid)
				{
					...
					if (oMessagesBodiesDom)
					{
						...
						if (!oTextBody || !oTextBody[0])
						{
							...
							else if (Utils.isNormal(oData.Result.Plain) && '' !== oData.Result.Plain)
							{
								...
								if ((oMessage.isPgpSigned() || oMessage.isPgpEncrypted()) && __webpack_require__(/*! Stores/User/Pgp */ 24).capaOpenPGP())
								{
					...
					{
						__webpack_require__(/*! App/User */ 6).messageListAction(oMessage.folderFullNameRaw,
				...
				viewModel: {
					createViewModel: function(oParams, oCmponentInfo) {
						...
						if (oCmponentInfo.element)
						{
							...
							__webpack_require__(/*! Common/Translator */ 8).i18nToNodes(oParams.element);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractComponent = __webpack_require__(/*! Component/Abstract */ 31)
		;
		...
		function ClientStorage()
		{
			var
				NextStorageDriver = __webpack_require__(/*! _ */ 2).find([
					__webpack_require__(/*! Common/ClientStorageDriver/LocalStorage */ 101),
					__webpack_require__(/*! Common/ClientStorageDriver/Cookie */ 100)
...
/***/ function(module, exports, __webpack_require__) {
	...
	//		SettingsStore = require('Stores/User/Settings'),
			...
			MessageSimpleModel = __webpack_require__(/*! Model/MessageSimple */ 110),

			PromisesPopulator = __webpack_require__(/*! Promises/User/Populator */ 114),
			AbstractAjaxPromises = __webpack_require__(/*! Promises/AbstractAjax */ 113)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		function LanguagesPopupView()
		{
			...
			this.LanguageStore = __webpack_require__(/*! Stores/Language */ 33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractBoot = __webpack_require__(/*! Knoin/AbstractBoot */ 61)
		;
	...
	//		});
		...
		AbstractApp.prototype.bootstart = function ()
		{
			...
			var
				ssm = __webpack_require__(/*! ssm */ 81),
				ko = __webpack_require__(/*! ko */ 3)
			;

			ko.components.register('SaveTrigger', __webpack_require__(/*! Component/SaveTrigger */ 57));
			ko.components.register('Input', __webpack_require__(/*! Component/Input */ 54));
			ko.components.register('Select', __webpack_require__(/*! Component/Select */ 58));
			ko.components.register('TextArea', __webpack_require__(/*! Component/TextArea */ 59));
			ko.components.register('Radio', __webpack_require__(/*! Component/Radio */ 56));

			if (Settings.settingsGet('MaterialDesign') && Globals.bAnimationSupported)
			{
				ko.components.register('Checkbox', __webpack_require__(/*! Component/MaterialDesign/Checkbox */ 55));
			}
			else
			{
	//			ko.components.register('Checkbox', require('Component/Classic/Checkbox'));
				ko.components.register('Checkbox', __webpack_require__(/*! Component/Checkbox */ 53));
			}
			...
			__webpack_require__(/*! Stores/Language */ 33).populate();
			__webpack_require__(/*! Stores/Theme */ 40).populate();
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstracRadio = __webpack_require__(/*! Component/AbstracRadio */ 52)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			window = __webpack_require__(/*! window */ 10),
			ko = __webpack_require__(/*! ko */ 3),
			buzz = __webpack_require__(/*! buzz */ 167),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			Globals = __webpack_require__(/*! Common/Globals */ 7),
			Utils = __webpack_require__(/*! Common/Utils */ 1),
			Selector = __webpack_require__(/*! Common/Selector */ 82),
			Links = __webpack_require__(/*! Common/Links */ 13),
			Translator = __webpack_require__(/*! Common/Translator */ 8),
			...
			EmailModel = __webpack_require__(/*! Model/Email */ 26),
			ContactModel = __webpack_require__(/*! Model/Contact */ 104),
			ContactPropertyModel = __webpack_require__(/*! Model/ContactProperty */ 105),
		...
		function ContactsPopupView()
		{
			...
			this.newMessageCommand = Utils.createCommand(this, function () {
				...
				if (Utils.isNonEmptyArray(aE))
				{
					...
					kn.hideScreenPopup(__webpack_require__(/*! View/Popup/Contacts */ 72));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractModel = __webpack_require__(/*! Knoin/AbstractModel */ 23)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			FilterConditionModel = __webpack_require__(/*! Model/FilterCondition */ 106),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			FilterStore = __webpack_require__(/*! Stores/User/Filter */ 87),
			FolderStore = __webpack_require__(/*! Stores/User/Folder */ 20),
	...
	(function () {
		...
		function FolderCreateView()
		{
			...
			this.createFolder = Utils.createCommand(this, function () {
				...
				__webpack_require__(/*! App/User */ 6).foldersPromisesActionHelper(
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/KeyboardShortcutsHelp */ 95));
		};
		...
		AbstractSystemDropDownUserView.prototype.addAccountClick = function ()
		{
			...
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Account */ 71));
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AttachmentModel = __webpack_require__(/*! Model/Attachment */ 83),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			var
				sSent = __webpack_require__(/*! Stores/User/Folder */ 20).sentFolder(),
				sDraft = __webpack_require__(/*! Stores/User/Folder */ 20).draftFolder()
			;
		...
		MessageModel.prototype.initUpdateByMessageJson = function (oJsonMessage)
		{
			...
			if (oJsonMessage && 'Object/Message' === oJsonMessage['@Object'])
			{
				...
				if (__webpack_require__(/*! Stores/User/Pgp */ 24).capaOpenPGP())
				{
	...
	//		}
		...
		MessageModel.prototype.getDataForWindowPopup = function ()
		{
			return {
				...
				'popupDate': __webpack_require__(/*! Common/Momentor */ 21).format(this.dateTimeStampInUTC(), 'FULL'),
		...
		{
			if (this.body && __webpack_require__(/*! Stores/User/Pgp */ 24).capaOpenPGP())
			{
				this.body.data('rl-pgp-verify-status', this.pgpSignedVerifyStatus());
				this.body.data('rl-pgp-verify-user', this.pgpSignedVerifyUser());
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractBasicPromises = __webpack_require__(/*! Promises/AbstractBasic */ 85)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			FolderModel = __webpack_require__(/*! Model/Folder */ 107),
	...
	(function () {
		...
		function AboutUserScreen()
		{
			AbstractScreen.call(this, 'about', [
				__webpack_require__(/*! View/User/About */ 154)
			]);
		}
	...
	(function () {
		...
		function LoginUserScreen()
		{
			AbstractScreen.call(this, 'login', [
				__webpack_require__(/*! View/User/Login */ 155)
			]);
		}
	...
	(function () {
		...
		function MailBoxUserScreen()
		{
			AbstractScreen.call(this, 'mailbox', [
				__webpack_require__(/*! View/User/MailBox/SystemDropDown */ 159),
				__webpack_require__(/*! View/User/MailBox/FolderList */ 156),
				__webpack_require__(/*! View/User/MailBox/MessageList */ 157),
				__webpack_require__(/*! View/User/MailBox/MessageView */ 158)
			]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractSettingsScreen = __webpack_require__(/*! Screen/AbstractSettings */ 63)
		;
		...
		function SettingsUserScreen()
		{
			AbstractSettingsScreen.call(this, [
				__webpack_require__(/*! View/User/Settings/SystemDropDown */ 162),
				__webpack_require__(/*! View/User/Settings/Menu */ 160),
				__webpack_require__(/*! View/User/Settings/Pane */ 161)
			]);
		...
		{
			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/General */ 137),
				'SettingsGeneral', 'SETTINGS_LABELS/LABEL_GENERAL_NAME', 'general', true);

			if (AppStore.contactsIsAllowed())
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Contacts */ 134),
					'SettingsContacts', 'SETTINGS_LABELS/LABEL_CONTACTS_NAME', 'contacts');
			}

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Accounts */ 132), 'SettingsAccounts',
			...
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Filters */ 135),
			...
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Security */ 139),
			...
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Social */ 140),
					'SettingsSocial', 'SETTINGS_LABELS/LABEL_SOCIAL_NAME', 'social');
			}

			if (Settings.settingsGet('ChangePasswordIsAllowed'))
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/ChangePassword */ 133),
					'SettingsChangePassword', 'SETTINGS_LABELS/LABEL_CHANGE_PASSWORD_NAME', 'change-password');
			}

			if (Settings.capa(Enums.Capa.Templates))
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Templates */ 141),
					'SettingsTemplates', 'SETTINGS_LABELS/LABEL_TEMPLATES_NAME', 'templates');
			}

			kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Folders */ 136),
				'SettingsFolders', 'SETTINGS_LABELS/LABEL_FOLDERS_NAME', 'folders');

			if (Settings.capa(Enums.Capa.Themes))
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/Themes */ 142),
					'SettingsThemes', 'SETTINGS_LABELS/LABEL_THEMES_NAME', 'themes');
			}

			if (Settings.capa(Enums.Capa.OpenPGP))
			{
				kn.addSettingsViewModel(__webpack_require__(/*! Settings/User/OpenPgp */ 138),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		AccountsUserSettings.prototype.editAccount = function (oAccountItem)
		{
			...
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Account */ 71), [oAccountItem]);
			}
		};

		AccountsUserSettings.prototype.addNewIdentity = function ()
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Identity */ 94));
		};

		AccountsUserSettings.prototype.editIdentity = function (oIdentity)
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Identity */ 94), [oIdentity]);
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		FiltersUserSettings.prototype.updateList = function ()
		{
			var
				self = this,
				FilterModel = __webpack_require__(/*! Model/Filter */ 84)
			;
		...
		FiltersUserSettings.prototype.addFilter = function ()
		{
			...
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(
				__webpack_require__(/*! View/Popup/Filter */ 92), [oNew, function  () {
		...
		FiltersUserSettings.prototype.editFilter = function (oEdit)
		{
			...
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(
				__webpack_require__(/*! View/Popup/Filter */ 92), [oCloned, function  () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/FolderCreate */ 93));
		};

		FoldersUserSettings.prototype.systemFolder = function ()
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/FolderSystem */ 46));
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AppStore = __webpack_require__(/*! Stores/User/App */ 29),
			LanguageStore = __webpack_require__(/*! Stores/Language */ 33),
			SettingsStore = __webpack_require__(/*! Stores/User/Settings */ 25),
			NotificationStore = __webpack_require__(/*! Stores/User/Notification */ 70),
			MessageStore = __webpack_require__(/*! Stores/User/Message */ 30),
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Languages */ 47));
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/AddOpenPgpKey */ 146));
		};

		OpenPgpUserSettings.prototype.generateOpenPgpKey = function ()
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/NewOpenPgpKey */ 150));
		};
		...
		OpenPgpUserSettings.prototype.viewOpenPgpKey = function (oOpenPgpKey)
		{
			if (oOpenPgpKey)
			{
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/ViewOpenPgpKey */ 153), [oOpenPgpKey]);
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			SettinsStore = __webpack_require__(/*! Stores/User/Settings */ 25),
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/TwoFactorTest */ 152), [this.twoFactorTested]);
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Template */ 96));
		};
		...
		TemplatesUserSettings.prototype.editTemplate = function (oTemplateItem)
		{
			if (oTemplateItem)
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Template */ 96), [oTemplateItem]);
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			ThemeStore = __webpack_require__(/*! Stores/Theme */ 40),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		AdvancedSearchPopupView.prototype.buildSearchString = function ()
		{
			...
			{
				aResult.push('date:' + __webpack_require__(/*! Common/Momentor */ 21).searchSubtractFormatDateHelper(this.selectedDateValue()) + '/');
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/Languages */ 47));
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderCreate */ 93));
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			key = __webpack_require__(/*! key */ 16),
			Jua = __webpack_require__(/*! Jua */ 78),
			ifvisible = __webpack_require__(/*! ifvisible */ 168),
			...
			QuotaStore = __webpack_require__(/*! Stores/User/Quota */ 88),
			SettingsStore = __webpack_require__(/*! Stores/User/Settings */ 25),
			FolderStore = __webpack_require__(/*! Stores/User/Folder */ 20),
			MessageStore = __webpack_require__(/*! Stores/User/Message */ 30),
		...
		function MessageListMailBoxUserView()
		{
			...
			this.clearCommand = Utils.createCommand(this, function () {
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderClear */ 149), [FolderStore.currentFolder()]);
			});
		...
		{
			__webpack_require__(/*! App/User */ 6).messageListAction(sFolderFullNameRaw, mUid, iSetAction, aMessages);
		};
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/AdvancedSearch */ 147));
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			PhotoSwipe = __webpack_require__(/*! PhotoSwipe */ 164),
			PhotoSwipeUI_Default = __webpack_require__(/*! PhotoSwipeUI_Default */ 165),
	...
	//					sResult = 'icon-warning-alt iconcolor-green';
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/Compose */ 27), [sType, MessageStore.message()]);
		};
	...
	//							'getThumbBoundsFn': fThumbBoundsFn,
		...
		MessageViewMailBoxUserView.prototype.flagViewMessage = function ()
		{
			...
			if (oMessage)
			{
				__webpack_require__(/*! App/User */ 6).messageListAction(oMessage.folderFullNameRaw, oMessage.uid,
		...
		MessageViewMailBoxUserView.prototype.editMessage = function ()
		{
			if (MessageStore.message())
			{
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/Compose */ 27), [Enums.ComposeType.Draft, MessageStore.message()]);
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			kn = __webpack_require__(/*! Knoin/Knoin */ 5),
			AbstractSystemDropDownViewModel = __webpack_require__(/*! View/User/AbstractSystemDropDown */ 97)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			kn = __webpack_require__(/*! Knoin/Knoin */ 5),
			AbstractSystemDropDownUserView = __webpack_require__(/*! View/User/AbstractSystemDropDown */ 97)
		;
